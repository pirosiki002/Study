...
function App() {
  ...
  let phoneNo = "0322222222";
  let newPhoneNo = 0;

  // ハイフン付きで厳密に確認する場合
  var validateTel = function (value) {
    var formattedNumber = new AsYouType('JP').input(value)
    console.log("formattedNumber =", formattedNumber);

    return formattedNumber;
  }

  // newPhoneNo = new AsYouType('jp').input('09611111111');
  newPhoneNo = validateTel(phoneNo);
  ...
  //   // 参考：https://web.analogstd.com/tips/posts/js/how-to-format-phone-number.php
  //   $STRICT = $STRICT || false;
  //   // 市外局番のグループ定義
